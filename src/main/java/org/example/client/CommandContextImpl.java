...
import org.example.transport.transceiver.ChannelProvider;
import org.example.transport.transceiver.Message;
import org.example.transport.transceiver.MessageFactory;
...
public class CommandContextImpl implements CommandContext {
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#isConnected()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#printLine(java.lang .String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#printColumns(java .util.Collection)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#clearScreen()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#terminateSession()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#isTerminated()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#connectController (java.lang.String, int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#disconnectController ()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#getDefaultControllerHost ()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#getDefaultControllerPort ()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#getControllerHost()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#getControllerPort()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.restcomm.ss7.management.console.client.CommandContext#getHistory()
     */
    @Override
